...
textActor.GetPositionCoordinate().SetValue(0.3, 0.3)
textActor.GetPosition2Coordinate().SetCoordinateSystemToNormalizedDisplay()
textActor.GetPosition2Coordinate().SetValue(0.9, 0.9)
